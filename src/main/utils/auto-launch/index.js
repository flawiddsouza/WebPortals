...
export default class AutoLaunch {
  ...
  constructor({ name, path, options }) {
    ...
    const opts = {
      ...
      options: {
        launchInBackground:
          options && options.launchInBackground != null ? options.launchInBackground : false,
        mac: options && options.mac != null ? options.mac : {},
        extraArguments: options && options.extraArgs != null ? options.extraArgs : []
      }
    }

    const versions =
      typeof process !== 'undefined' && process !== null ? process.versions : undefined
    if (path != null) {
